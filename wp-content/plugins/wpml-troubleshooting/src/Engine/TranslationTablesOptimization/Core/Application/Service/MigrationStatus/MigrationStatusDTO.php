...
namespace WPML\Troubleshooting\Engine\TranslationTablesOptimization\Core\Application\Service\MigrationStatus;

use WPML\Troubleshooting\Engine\TranslationTablesOptimization\Core\Domain\MigrationStatus\MigrationStatus;
