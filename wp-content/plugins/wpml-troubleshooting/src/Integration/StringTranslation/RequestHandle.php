...
class RequestHandle implements \IWPML_Action {
	...
	public function add_hooks() {
		\WPML\Request\Adapter\Ajax::register( $this->action, \WPML\Request\Policy\Policy::capability( 'wpml_manage_troubleshooting', \WPML\Request\Policy\Authenticity::actionNonce( BackendHooks::NONCE_KEY, 'nonce' ) ), [ $this, 'handle' ] );
	}
