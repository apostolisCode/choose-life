...
namespace WPML\Troubleshooting\Integration\TranslationManagement\SynchronizeSourceIdOfATEJobs;
...
class TriggerSynchronization implements \IWPML_Backend_Action, \IWPML_DIC_Action {
	...
	public function add_hooks() {
		...
		\WPML\Request\Adapter\Ajax::register( self::ACTION_ID, \WPML\Request\Policy\Policy::capability( [ 'wpml_manage_troubleshooting', 'manage_translations' ], \WPML\Request\Policy\Authenticity::actionNonce( self::ACTION_ID, 'nonce' ) ), array( $this, 'clearExecutedStateToForceUpgrade' ) );
	}
	...
	public function displayButton() {
		...
		<p>
			<input id="wpml_tm_ate_source_id_migration_btn"
				   ...
				   value="<?php esc_attr_e( 'Synchronize local job ids with ATE jobs', 'wpml-troubleshooting' ); ?>"
	...
	public function enqueueScripts( $hook ) {
		if ( WPML_PLUGIN_FOLDER . '/menu/troubleshooting.php' === $hook ) {
			wp_enqueue_script(
				self::ACTION_ID,
				WPML_TROUBLESHOOTING_URL . '/res/js/ate-jobs-migration.js',
				[ 'jquery' ],
