...
if ( 0 === strcmp( $filtered_page, WPML_PLUGIN_FOLDER . '/menu/support.php' ) || ( isset( $pagenow ) && $pagenow === 'index.php' ) ) {
	...
	if ( ! empty( $icl_ncp_plugins2 ) ) {
		if ( 0 === strcmp( $filtered_page, WPML_PLUGIN_FOLDER . '/menu/support.php' ) ) {
