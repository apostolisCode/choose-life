...
class Option {
	...
	const SHOULD_ENABLE_HANDLE_MEDIA_AUTO_ON_ST_ACTIVATION = 'should_enable_handle_media_auto_on_st_activation';
	...
	public static function setShouldEnableHandleMediaAutoOnStActivation() {
		self::set( self::SHOULD_ENABLE_HANDLE_MEDIA_AUTO_ON_ST_ACTIVATION, 1 );
	}
	...
	public static function removeShouldEnableHandleMediaAutoOnStActivation() {
		self::remove( self::SHOULD_ENABLE_HANDLE_MEDIA_AUTO_ON_ST_ACTIVATION );
	}
	...
	public static function shouldEnableHandleMediaAutoOnStActivation() {
		return self::get( self::SHOULD_ENABLE_HANDLE_MEDIA_AUTO_ON_ST_ACTIVATION, null ) !== null;
	}
