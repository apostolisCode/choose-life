...
class Capture implements CaptureInterface {
  ...
  public function capture(
    ...
    $payload = [
      ...
      'timestamp'   => $this->resolveTimestamp( $properties ),
    ];
  ...
  protected function resolveTimestamp( array $properties ) {
    if (
      ! empty( $properties['queued_event'] )
      && isset( $properties['original_event_time'] )
      && is_string( $properties['original_event_time'] )
      && '' !== $properties['original_event_time']
    ) {
      return $properties['original_event_time'];
    }
