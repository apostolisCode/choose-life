...
class LanguageDto {
  ...
  const AUTOMATIC_TRANSLATION_REASON_MANUAL_ONLY     = 'manual-only';
  const AUTOMATIC_TRANSLATION_REASON_SAME_AS_DEFAULT = 'same-as-default';
  ...
  private $automaticTranslationsUnavailableReason = null;
  ...
  public function getAutomaticTranslationsUnavailableReason() {
    return $this->automaticTranslationsUnavailableReason;
  }


  public function setAutomaticTranslationsUnavailableReason( ?string $reason = null ) {
    $this->automaticTranslationsUnavailableReason = $reason;
  }
