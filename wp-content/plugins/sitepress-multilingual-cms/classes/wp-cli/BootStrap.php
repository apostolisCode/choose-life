...
use WPML\CLI\Core\Commands\MigrateLanguagesFactory;
use WPML\CLI\Core\Commands\PullDeliveryFactory;
...
class BootStrap {
	...
	public function init() {
		$commands_factory = [
			...
			MigrateLanguagesFactory::class,
			PullDeliveryFactory::class,
		];
