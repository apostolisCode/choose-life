...
class WPML_Rewrite_Rules_Filter {
	...
	private $use_directory_for_default_language;

	public function __construct( $active_languages, $wpml_url_filters = null, $use_directory_for_default_language = false ) {
		$this->active_languages = $active_languages;
		$this->use_directory_for_default_language = (bool) $use_directory_for_default_language;
	...
	public function rid_of_language_param( $htaccess_string ) {
		if (
			$this->use_directory_for_default_language
			|| $this->wpml_url_filters->frontend_uses_root()
			|| $this->is_permalink_page()
			|| $this->is_shop_page()
		) {
