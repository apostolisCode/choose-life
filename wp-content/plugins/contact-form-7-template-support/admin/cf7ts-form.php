		...
		<div class="half-left">
			...
			<?php else : ?>
				...
				<ul class="cf7ts-list">
					...
					<li><?php _e( 'Put the following code in your <code>gulp/config/theme.js</code> file', 'cf7ts' ); ?>
						<pre>module.exports = { options: { transform: { preserve: new RegExp(["(^|\\s)Template Name:.*","(^|\\s)CF7-Template:.*"].join('|'), 'g')}}};</pre>
					</li>
				</ul>
				<p>
