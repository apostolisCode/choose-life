 ...
 */
class CRL_Walker_Nav_Menu extends Walker_Nav_Menu {
	...
	public function start_lvl( &$output, $depth = 0, $args = array() ) {
		...
		$list_classes_str = $args->menu_class . implode( " $args->menu_class", (array) $list_classes );
	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		// BEM-ify the given sub classes
		$item_classes_str = $args->menu_class . implode( " $args->menu_class", (array) $item_classes );
		...
		$output .= $args->before;
		$output .= CRL_Html::get_element( $tag, $attrs, $link_content );
		$output .= $args->after;
	}
